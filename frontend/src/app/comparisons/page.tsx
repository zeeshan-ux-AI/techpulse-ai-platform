...
export default async function ComparisonsPage() {
  let posts: Post[] = [];
  try {
    const res = await api.getPosts({ type: 'COMPARISON', limit: '20' });
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
      <div className="border-b border-slateDark-800 pb-6 space-y-2">
        ...
        <h1 className="text-4xl font-black text-white">Side-by-Side Tech Comparisons</h1>
        <p className="text-slate-300 text-sm">Head-to-head technical comparisons between competing AI models, IDEs, and tools.</p>
      </div>
